package carrie.toys.mipark.activity;
...
import carrie.toys.mipark.R;
import carrie.toys.mipark.adapter.MainAdapter;
import carrie.toys.mipark.data.Favorite_DBopenHelper;
import carrie.toys.mipark.data.Main_Data;
import carrie.toys.mipark.data.Pause_DBOpenHelper;
import carrie.toys.mipark.mediaplayer.ContinueMediaPlayer;
import carrie.toys.mipark.util.Crypto;
import carrie.toys.mipark.util.HangulUtil;
import carrie.toys.mipark.util.PreferenceUtil;
import carrie.toys.mipark.util.Utils;
import carrie.toys.mipark.youtubeplayer.CustomYoutubePlayer;
...
public class MainActivity extends Activity implements OnItemClickListener, OnClickListener, OnScrollListener, AdViewListener, CustomPopupListener, InterstitialAdListener{
	...
	AdMixerManager.getInstance().setAdapterDefaultAppCode(AdAdapter.ADAPTER_ADMIXER, "aqrjb1p4");
	AdMixerManager.getInstance().setAdapterDefaultAppCode(AdAdapter.ADAPTER_ADMOB, "ca-app-pub-4637651494513698/4132858691");
	AdMixerManager.getInstance().setAdapterDefaultAppCode(AdAdapter.ADAPTER_ADMOB_FULL, "ca-app-pub-4637651494513698/3941287004");
//	  Custom Popup 시작
	CustomPopup.setCustomPopupListener(this);
	CustomPopup.startCustomPopup(this, "aqrjb1p4");
...
//		admobNative.destroy();
	...
	private void init_admob_naive(){
		...
		admobNative.setAdUnitId("ca-app-pub-4637651494513698/7497388638");
		nativeContainer.addView(admobNative);
		admobNative.loadAd(adRequest);
	}
	
	public void addBannerView() {
    	AdInfo adInfo = new AdInfo("aqrjb1p4");
